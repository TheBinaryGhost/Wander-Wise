      ...
      {!data || data.length === 0 ? (
        <Card className="py-16">
          <CardContent className="flex flex-col items-center justify-center text-center">
            ...
            <Link to="/trips/add">
              <Button className="bg-amber-500 hover:bg-amber-600 text-white">Create a Trip</Button>
            </Link>
          </CardContent>
        </Card>
      ) : (
            ...
            <Card key={trip._id} className="group hover:shadow-lg transition-shadow duration-200">
              ...
              <CardContent className="space-y-4">
                ...
                <Link to={`/baggage/${trip._id}`}>
                  <Button className="w-full border-amber-300 text-amber-600 hover:bg-amber-50" variant="outline">
